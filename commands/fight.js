...
module.exports.run = (bot, message, args) => {
  ...
  if (!member) return message.reply("**Mention someone to fight!** `?fight <user>`");
  if (member.id === message.author.id) return message.reply("You can't fight yourself! `?fight <user>`");
